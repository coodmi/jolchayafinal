<div id="footer" class="tab-content">
    <style>
        ...
        .btn-reset:hover { background: #4b5563 !important; transform: translateY(-2px); box-shadow: 0 4px 12px rgba(107,114,128,0.3); }
        ...
        <form id="footerSettingsForm" onsubmit="return false;">
                ...
                <div class="form-grid">
                    <div class="form-group" style="grid-column: 1 / -1;">
                        <label class="form-label" for="footerLogoFile">
                            ...
                            <small style="display: block; color: #6b7280; font-weight: 400; margin-top: 2px;">PNG/SVG/JPG/WEBP সমর্থিত। সর্বোচ্চ 7MB (যেকোনো রেজুলেশন)</small>
                        </label>
                        ...
                        <div id="footerLogoPreview" style="margin-top: 10px; display: none;">
                            <img id="footerLogoPreviewImg" src="" alt="Logo Preview" style="max-height: 80px; width: auto; border: 1px solid #e5e7eb; border-radius: 8px; padding: 8px;">
                        </div>
                    </div>
            ...
            <div style="background: #f9fafb; border-radius: 12px; padding: 20px; margin-bottom: 24px; border: 1px solid #e5e7eb;">
                ...
                <div class="form-grid">
                    <div class="form-group" style="grid-column: 1 / -1;">
                        <label class="form-label" for="concernTitle">
                            ...
                            <small style="display: block; color: #6b7280; font-weight: 400; margin-top: 2px;">Section Title (e.g., Concern of NEX Group)</small>
                        </label>
                ...
                <div style="margin-top: 20px;">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
                        ...
                        <button type="button" id="addConcernLogoBtn" style="padding: 8px 16px; background: #10b981; color: white; border: none; border-radius: 8px; cursor: pointer; font-weight: 600; transition: all 0.3s;">
            ...
            <script>
                ...
                function addLogoEntry(url = '', imageData = null, imagePath = '') {
                    ...
                    logoEntry.innerHTML = `
                        <button type="button" onclick="removeLogoEntry(${logoId})" style="position: absolute; top: 8px; right: 8px; background: #ef4444; color: white; border: none; border-radius: 6px; width: 28px; height: 28px; cursor: pointer; font-size: 12px; transition: all 0.3s;">
                            <i class="fas fa-times"></i>
                        </button>
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 12px;">
                            <div>
                                <label style="display: block; font-weight: 600; color: #374151; margin-bottom: 6px;">Website URL</label>
                                <input type="text" id="logo-url-${logoId}" class="search-input" placeholder="https://example.com" value="${url}" style="padding: 8px 12px; border: 1px solid #d1d5db; border-radius: 6px; width: 100%;">
                            </div>
                            <div>
                                <label style="display: block; font-weight: 600; color: #374151; margin-bottom: 6px;">Logo Image</label>
                                <input type="file" id="logo-file-${logoId}" accept="image/*" style="padding: 6px; border: 1px solid #d1d5db; border-radius: 6px; width: 100%; font-size: 13px;" onchange="handleLogoFileChange(${logoId})">
                            </div>
                        </div>
                        <div id="logo-preview-${logoId}" style="display: ${imageData || imagePath ? 'flex' : 'none'}; align-items: center; gap: 12px; padding: 12px; background: #f9fafb; border-radius: 8px; border: 1px dashed #d1d5db;">
                            <img id="logo-preview-img-${logoId}" src="${imageData || (imagePath ? '/storage/' + imagePath : '')}" alt="Logo Preview" style="max-height: 60px; max-width: 120px; width: auto; object-fit: contain;">
                            <span style="font-size: 12px; color: #6b7280;">Logo preview</span>
                        </div>
                    `;
                    container.appendChild(logoEntry);
                    concernLogos.push({ id: logoId, url: url, imageData: imageData, imagePath: imagePath });
                }
                ...
                function handleLogoFileChange(logoId) {
                    ...
                    if (fileInput.files && fileInput.files[0]) {
                        ...
                        reader.onload = function(e) {
                            ...
                            if (logo) logo.imageData = e.target.result;
                        };
                ...
                function loadConcernLogos(logos) {
                    if (logos && Array.isArray(logos)) {
                        logos.forEach(logo => { addLogoEntry(logo.url || '', logo.imageData || null, logo.image_path || ''); });
                    }
                }

                setTimeout(() => {
                    if (concernLogos.length === 0) addLogoEntry();
                }, 100);
            </script>
                ...
                <div class="form-grid">
                    <div class="form-group">
                        <label class="form-label" for="brochureFile">
                            ...
                            <small style="display: block; color: #6b7280; font-weight: 400; margin-top: 2px;">প্রকল্পের ব্রোশিয়ার ফাইল</small>
                        </label>
                    ...
                    <div class="form-group">
                        <label class="form-label" for="masterPlanFile">
                            ...
                            <small style="display: block; color: #6b7280; font-weight: 400; margin-top: 2px;">মাস্টার প্ল্যান ফাইল</small>
                        </label>
                    ...
                    <div class="form-group">
                        <label class="form-label" for="priceListFile">
                            ...
                            <small style="display: block; color: #6b7280; font-weight: 400; margin-top: 2px;">মূল্য তালিকা ফাইল</small>
                        </label>
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group" style="grid-column: 1 / -1;">
                        <label class="form-label" for="nexRealEstateUrl">
                            ...
                            <small style="display: block; color: #6b7280; font-weight: 400; margin-top: 2px;">Link for "NEX Real Estate" text in footer</small>
                        </label>
                        <input id="nexRealEstateUrl" type="text" class="search-input" placeholder="https://nexrealestate.com">
                    </div>
                </div>
            </div>
        ...
        <div style="display:flex; gap:32px; padding:16px;">
            <div style="flex:1; min-width:220px;">
                ...
                <div id="pvConcernSection" style="margin-top: 16px; display: none;">
                    <h4 id="pvConcernTitle" style="color: #fff; font-size: 14px; margin: 0 0 8px 0; font-weight: 600;">Concern of</h4>
                    <img id="pvConcernImg" src="" alt="Concern Logo" style="max-height: 50px; width: auto; background: white; padding: 5px; border-radius: 4px;">
                </div>
            </div>
            <div style="flex:1; min-width:220px;">
