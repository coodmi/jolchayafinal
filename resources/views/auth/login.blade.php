      ...
      <form method="POST" action="{{ route('login.submit') }}" novalidate>
        ...
        <div class="mb-3">
          ...
          <div class="input-wrap">
            ...
            <input type="email" class="form-control email-input" id="email" name="email" value="{{ old('email') }}" required>
          </div>
        </div>
        <div class="mb-2">
        ...
        <div class="text-center mt-3">
          <p class="mb-2 helper">
            <a href="{{ route('password.request') }}" style="color:#16a34a; font-weight:700; text-decoration:none;">পাসওয়ার্ড ভুলে গেছেন?</a>
          </p>
          <p class="mb-0 helper">নতুন ব্যবহারকারী? <a href="{{ route('register') }}" style="color:#16a34a; font-weight:700; text-decoration:none;">রেজিস্টার করুন</a></p>
        </div>
      </form>
    </div>
  </div>
